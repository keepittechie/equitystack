...
Until fuller outcome evidence is assembled, the most supportable conclusion is a conditional one: dismantling equity-focused federal structures may matter because they were operating in an environment where unequal treatment had not disappeared and because part of the dismantled channels were directly tied to race-discrimination enforcement or desegregation support. That makes the rollback a live public-interest question, especially for Black workers, students, and communities affected by employment, contracting, education, and service-access disparities.',
  'The source base here mixes foundational academic studies, later large-scale audit research, one methodological follow-up paper, a recent preprint, and the Trump administration''s own policy text. It now also includes primary implementation documents from OPM, DOL, DOJ, EEOC, and the Department of Education. The source set distinguishes summary links from primary academic records.

Use the 2003 AEA paper and the 2021-2022 NBER working paper as the strongest baseline evidence. Use the 2024 report-card paper for employer-level accountability framing. Use the 2026 arXiv paper as newer but still provisional evidence because it is a preprint. Use the White House order, OPM memos, DOL enforcement documents, DOJ/EEOC guidance, and Department of Education press releases as the primary record of what agencies were directed to do and what agencies actually did in documented actions. For Black-impact-specific channels, pay special attention to the Equity Assistance Center program page and to OFCCP case examples involving African American or Black applicants because those sources show what kinds of race-related support or remedies the rollback is cutting back from.',
  1
)
...
INSERT INTO explainer_sources (
  ...
  '2025-03-19',
  'DOJ and EEOC announced technical-assistance documents positioning workplace DEI-related workplace practices as potential Title VII violations.',
  13
), (
  @hiring_discrimination_anti_dei_explainer_id,
