...
INSERT INTO explainers (
  ...
  'How one of the most celebrated U.S. opportunity programs expanded education and homeownership for millions of veterans while Black veterans often faced segregated colleges, lending discrimination, and unequal local implementation.',
...
Black veterans often faced constrained college options, overcrowded HBCUs, and exclusion from white institutions, especially in the South.
...
This topic also matters because the GI Bill is often cited as a model of broad-based opportunity policy. To understand what it can and cannot teach us, readers need both halves of the record: the program did transform American life, and Black veterans were often prevented from accessing its biggest wealth-building channels on equal terms.',
  'The GI Bill helped all veterans equally, regardless of race.',
  'The original GI Bill was written in race-neutral terms, but access to its most valuable benefits was filtered through local and state institutions that were already segregated or discriminatory. In education, many Black veterans in the South faced exclusion from white colleges while historically Black colleges and universities had limited capacity and resources. That meant the education benefit did not translate into equal college access.

Housing worked similarly. The GI Bill''s loan guaranty supported home purchases, but Black veterans still had to deal with local banks, segregated suburbs, appraisal discrimination, and the broader FHA-era system of redlining and exclusion. In practice, many white veterans could use GI Bill-backed education and housing benefits to build lasting wealth, while many Black veterans were blocked from those same pathways.

The strongest interpretation is not that the GI Bill was meaningless for Black veterans. Some did benefit, and gains were not identical across regions. The stronger evidence-based claim is that the GI Bill''s implementation often reproduced existing racial hierarchy, especially in southern higher education and postwar housing markets.',
