...
const WORKFLOW_DEFINITIONS = [
    ...
    steps: [
      {
        ...
        title: "Run",
        description: "Discover, batch, normalize, review, and promote the AI-first queue.",
      },
      {
        actionId: "currentAdmin.review",
        title: "Review",
        description: "Resolve only the remaining manual-review slice and sync the decision log when needed.",
      },
      {
  ...
  },
  {
    ...
    description: "Supporting current-admin commands that still operate on the same canonical artifacts.",
    workflowFamily: "current-admin",
    group: "Advanced",
    ...
    steps: [
      ...
      { actionId: "currentAdmin.deepReview", title: "Deep AI Review" },
