...
export function buildFutureBillDetailHref(bill) {
  return `/future-bills/${buildFutureBillCardSlug(bill)}`;
}
...
export function buildPresidentCardHref(president) {
  return `/card/president/${president?.slug}`;
}
