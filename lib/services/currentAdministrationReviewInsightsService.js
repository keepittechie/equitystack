...
const ACTIVE_MANUAL_REVIEW_OPERATOR_ACTIONS = new Set(["manual_review_required"]);
...
function availableOperatorActionsForItem(value) {
  ...
  if (hasStructuredEditPayload(value)) {
    return ["approve_as_is", "approve_with_changes", ...DEFAULT_MANUAL_REVIEW_ACTIONS.slice(1)];
  }
