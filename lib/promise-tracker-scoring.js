...
export function getPromiseScoreMethodology() {
  return {
    ...
    notes: [
      ...
      "Helpful promises delivered raise the score, while helpful promises that are blocked or fail lower it.",
      "Harmful promises delivered lower the score, while harmful promises that are blocked or fail are treated as neutral in v1.",
