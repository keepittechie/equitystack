      ...
      if (signal.action_id === "current_admin_precommit") {
        ...
        addRecommendation(
          ...
          createRecommendation({
            ...
            suggested_action: "Open the operator console with a guided status summary.",
    ...
    if (signal.type === "no_recent_success") {
      addRecommendation(
        ...
        createRecommendation({
          ...
          suggested_action: "Open the operator console with a status summary prefilled.",
  ...
  if (legislativeSummary?.safe_next_action === "run dry-run") {
    addRecommendation(
      ...
      createRecommendation({
        ...
        suggested_action: "Open the operator console with legislative dry-run prefilled.",
  ...
  if (analytics?.most_blocked_actions?.[0]?.count > 0) {
    addRecommendation(
      ...
      createRecommendation({
        ...
        suggested_action: "Open the operator console with a guided attention summary.",
        href: buildOperatorConsoleHref({ actionId: "show_attention" }),
        priority: 80,
        source: "analytics",
        scenario_id: "blocked_action_loop",
