...
export const OPERATOR_ACTIONS = [
  {
    ...
    requires_input: true,
    input_type: "path",
    input_label: "Batch file path",
    input_placeholder: "data/current_admin_batches/trump_2025_batch_01.json",
    template_command:
      "./bin/equitystack current-admin workflow start --input {{input}}",
    validation_message:
      "Start Current-Admin Workflow requires a real batch file path before execution.",
    synonyms: [
  ...
  },
  {
    ...
    requires_input: true,
    input_type: "path",
    input_label: "Queue path",
    input_placeholder: "reports/current_admin/trump-2025-batch-01.manual-review-queue.json",
    template_command:
      "./bin/equitystack current-admin pre-commit --input {{input}}",
    validation_message:
      "Run Current-Admin Pre-Commit requires a real queue path before execution.",
