...
export const RESEARCH_CASES = [
  ...
  {
    id: "shelby-county-v-holder-voting-rights-act-2013",
    title: "Shelby County v. Holder",
    summary:
      "On June 25, 2013, the Supreme Court invalidated Section 4(b)'s coverage formula, leaving Section 5 preclearance without an operative formula for previously covered jurisdictions unless Congress enacted a new one or a court separately bailed a jurisdiction in.",
    type: "litigation",
    status: "decided",
    domains: ["voting_rights", "civil_rights"],
  },
  {
    id: "louisiana-v-callais-voting-rights-act-2026",
    title: "Louisiana v. Callais",
    summary:
      "The Supreme Court invalidated Louisiana's remedial second majority-Black congressional district and revised Section 2 redistricting doctrine in a way that makes vote-dilution claims harder to win.",
    type: "litigation",
    status: "decided",
    domains: ["voting_rights", "civil_rights"],
  },
...
export const CASE_POLICY_LINKS = [
  ...
  {
    case_id: "shelby-county-v-holder-voting-rights-act-2013",
    policy_id: 25,
    relationship: "judicial_constraint",
    confidence: 0.98,
    reasoning:
      "The June 25, 2013 decision invalidated Section 4(b)'s coverage formula, leaving Section 5 preclearance largely inoperative for previously covered jurisdictions and constraining a core federal voting-rights safeguard.",
    review_status: "verified",
  },
  {
    case_id: "louisiana-v-callais-voting-rights-act-2026",
    policy_id: 178,
    relationship: "judicial_constraint",
    confidence: 0.98,
    reasoning:
      "The April 29, 2026 decision invalidated Louisiana's remedial second majority-Black district and narrowed Section 2 redistricting enforcement, directly constraining a core federal voting-rights protection.",
    review_status: "verified",
  },
];
