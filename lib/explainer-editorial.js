const EXPLAINER_EDITORIAL = {
  ...
  "white-house-dei-economic-study": {
    ...
    sourcesResearchContext:
      "This explainer relies on the White House study PDF, labor-economics research on discrimination and talent allocation, civil-rights economic history, and research on diversity-performance evidence. The shared methodological point is narrow: the headline result should be evaluated through measurement, assumptions, and causality, not treated as self-proving.",
  },
};
