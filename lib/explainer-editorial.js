const EXPLAINER_EDITORIAL = {
  ...
  "new-deal-racial-exclusion-and-policy-support": {
    ...
    pagePurpose:
      "Use this page when the debate treats the New Deal as either universally inclusive or universally rejected after Black inclusion, and the first task is to separate coalition bargaining, documented exclusion, and later support politics.",
    whyThisMatters:
      "This explainer fills a gap between the site's broad benefits-history pages and its debate pages about intent or fairness. It shows how large social programs could expand security while still being structured through exclusion, and how later racialized backlash appears in some policy debates without explaining the whole history by itself.",
    argumentReady: {
      claim:
        "New Deal programs were universally inclusive, and they only became unpopular once Black Americans were included.",
      whyMisleading:
        "That bundles two different overstatements. Early New Deal programs often depended on coalition compromises and administrative structures that excluded or disadvantaged many Black workers and neighborhoods, while later racialized backlash is documented more clearly in some welfare and social-policy debates than in every program equally.",
      dataShows: [
        ...
        "Later inclusion and racialized public imagery did affect support in certain welfare debates, but not every program's popularity can be explained by Black inclusion alone.",
      ],
      bottomLine:
        "The strongest historical reading is that major New Deal programs were transformative but not neutral in design, and later politics around inclusion or perceived inclusion varied by program.",
      responseScript:
        "The New Deal was not simply inclusive or simply exclusionary in one single way. The better record is coalition politics, selective exclusion, unequal administration, and later backlash that appears unevenly across specific policy debates.",
      responseContext:
    ...
    questions: [
      ...
      "What evidence shows selective backlash or racialized policy feedback without turning every later support shift into the same story?",
    ],
    researchPaths: [
      {
    ...
    argumentMode: {
      summary:
        "Many New Deal programs were designed with exclusions or gatekeeping structures that helped secure political support, especially from Southern lawmakers. What people often miss is that later racialized backlash is documented in some welfare debates, but that does not mean every major social program became unpopular because Black Americans gained or were seen as gaining access.",
      quickResponse:
        "New Deal programs helped millions, but equal access was not built in from the start. The better story is political compromise, structured exclusion, and later backlash in some debates, not one universal rule for every program.",
      discussionResponse:
        "This debate usually collapses several different questions into one slogan. Some New Deal protections excluded key occupations or depended on local institutions that treated Black Americans unequally, especially in labor and housing, and those limits were tied to the coalition politics needed to pass national programs. Later politics also matter, because support for some welfare and social-policy debates became more racially coded over time, but that does not mean every program rose or fell for exactly the same reason.",
      debateResponse:
      ...
      keyPoints: [
        "Broad relief can be real without being broad on equal terms.",
        "The votes needed to pass a program shape who the program covers.",
        ...
        "Some later backlash is documented in policy debates where beneficiaries were racialized.",
        "That backlash record does not make every social program's popularity a one-cause race story.",
      ],
      commonClaims: [
        {
          claim:
  ...
  "universal-vs-targeted-programs-political-support": {
    ...
    pagePurpose:
      "Use this page when a debate treats support for social programs as a simple moral reaction and the first task is to show how eligibility design, visibility, administration, and coalition size shape political durability.",
    whyThisMatters:
      "This explainer fills a system-level gap between the site's New Deal history page and its welfare-statistics page. It explains why broad social insurance programs often build sturdier coalitions, why narrower means-tested programs are easier to stigmatize or burden, and why neither pattern should be treated as automatic.",
    argumentReady: {
      claim:
        "People just like some programs and hate welfare.",
      whyMisleading:
        "That skips over how programs are built. Support is shaped by whether large numbers of people pay in, expect to benefit, see recipients as people like themselves, and can understand the rules without passing through heavy administrative screening.",
      dataShows: [
    ...
    argumentMode: {
      summary:
        "Universal programs usually build broader and stabler political coalitions because more people pay in, expect to benefit, or recognize the benefit as part of normal citizenship. Targeted programs often face more resistance because narrow eligibility, heavier screening, stigma, and 'who benefits' narratives make them easier to single out, but that does not mean every targeted program is weak or every universal program is untouchable.",
      quickResponse:
      ...
      keyPoints: [
        ...
        "Universal programs are usually sturdier because they are harder to cast as someone else's benefit.",
        "Racialized beneficiary images can matter in some debates, but they are not the only reason support rises or falls.",
      ],
      commonClaims: [
        {
          claim:
