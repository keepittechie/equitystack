const EXPLAINER_EDITORIAL = {
  ...
  "party-voting-records-racial-policy": {
    ...
    argumentMode: {
      summary:
        "The better question is not which party name appeared on the ballot. It is which congressional coalition voted for or against a policy in that era, what the policy did, and whether the record shows explicit discrimination, civil-rights expansion, or racially disparate effects.",
      keyPoints: [
        "Party labels last longer than party coalitions, so a vote cast under the same party name can mean very different things across eras.",
        "Mid-century civil-rights votes often split by region as much as by party, especially between Southern Democrats, Northern Democrats, and liberal Republicans.",
        "Voting records can show support or opposition to a bill, but they do not automatically prove personal motive.",
        "Explicitly discriminatory laws and race-neutral laws with disparate outcomes need different kinds of evidence and should not be scored the same way.",
        "The 1964, 1965, and 2006 voting-rights and civil-rights votes look very different from later fights over crime, welfare, and modern election administration.",
        "EquityStack should weigh votes alongside bill text, enforcement, and documented outcomes rather than turning party labels into a shortcut.",
      ],
      commonClaims: [
        {
          claim:
      ...
      debateLines: [
        "Party names are not enough; you need era, region, coalition, and bill text.",
        "Voting records can show support or opposition, but they do not automatically read a lawmaker's mind.",
        "The 1964 and 1965 civil-rights votes are not best understood as today's Democrats versus today's Republicans.",
        "An explicit civil-rights vote and a race-neutral crime or welfare vote require different impact analysis.",
        "If you want a serious answer, follow the coalition, the statute, the enforcement, and the documented outcome.",
      ],
      shareCards: [
        {
          title: "Coalitions, not slogans",
          text:
            "The label Democrat or Republican is not enough by itself. The real question is which coalition voted for or against the law in that era, and what the law did.",
          context:
            "Use when someone treats party names as timeless proof.",
        },
        {
          title: "Votes show position, not motive",
          text:
            "A roll-call vote is direct evidence of support or opposition to a bill. It is not automatic proof of personal racial intent without bill text, statements, and outcome evidence.",
          context:
            "Use when a vote is being treated as mind-reading.",
        },
        {
          title: "Direct discrimination versus disparate impact",
          text:
            "Some laws discriminate explicitly in their text. Others are race-neutral on paper but have documented racial effects. Those are different evidence problems and should be analyzed differently.",
          context:
            "Use when formal neutrality is treated as the end of the discussion.",
        },
        {
          title: "Use the whole record",
          text:
            "The strongest historical method is simple: read the vote, read the bill, identify the coalition, check enforcement, and then measure outcomes.",
          context:
  ...
  "government-benefits-racial-gap": {
    ...
    argumentMode: {
      summary:
        "No. The historical record does not show neutral public help followed by equal access. It shows repeated public investment in land, housing, labor, education, and veterans benefits, with Black access often narrowed by the institutions that delivered those benefits.",
      keyPoints: [
        "Government did not only regulate markets; it also built wealth and stability through land policy, mortgage support, labor protections, education access, and veterans benefits.",
        "Those benefits ran through real delivery systems such as banks, colleges, agencies, and local gatekeepers rather than through abstract eligibility alone.",
        "Black Americans faced documented barriers across multiple benefit channels, which made the cumulative effect larger than any one program story.",
        "That record supports a cumulative-access argument: public help existed, but it was not distributed evenly in practice.",
        "This does not prove every program worked identically or that every present gap can be traced to one benefit system in isolation.",
        "The strongest claim is historical and cross-systemic: repeated unequal access to public support helped widen later disparities.",
      ],
      commonClaims: [
        {
          claim:
      ...
      debateLines: [
        "The real question is not whether public help existed. It is who could use it fully.",
        "Paper eligibility is not the same thing as equal delivery.",
        "Public investment built wealth in America, and access to that investment was not historically even.",
        "You do not need one single program to explain a gap when multiple benefit channels pointed in the same direction.",
        "A fair reading follows the delivery system, not just the statute.",
      ],
      shareCards: [
        {
          title: "Follow the delivery system",
          text:
            "Government help did not move through the economy automatically. It ran through lenders, colleges, agencies, and local gatekeepers, and those systems did not operate equally in practice.",
          context: "Use when someone treats paper eligibility as the full story.",
        },
        {
          title: "More than one program",
          text:
            "The record is cumulative. Land, mortgages, labor protections, education, and veterans benefits all mattered, and unequal access across several channels compounds over time.",
          context: "Use when the debate demands one single-policy explanation.",
        },
        {
          title: "Not a handout claim",
          text:
            "This is not mainly about who got a handout. It is about how public policy built wealth and security, and who had full access to those ladders.",
  ...
  "sentencing-disparities-united-states": {
    ...
    argumentMode: {
      summary:
        "No. A sentencing rule is not proven fair just because its text is race-neutral. The record shows punishment is shaped by thresholds, mandatory minimums, charging, plea leverage, guidelines, and access to relief, and those structures can generate patterned racial disparity.",
      keyPoints: [
        "Sentencing outcomes are shaped well before the judge announces a final number, including through statutes, charges, plea terms, and guidelines.",
        "Federal cocaine sentencing is one of the clearest examples of a punishment structure that fell heavily on Black defendants and Black communities.",
        "Disparity can emerge from the interaction of legal design and institutional discretion rather than from one single decision point.",
        "Later reforms narrowed some of the most visible disparities, which shows the punishment structure was policy-made rather than inevitable.",
        "This does not prove every sentence gap in every case is caused by racial discrimination.",
        "The stronger systemic claim is that formally neutral sentencing institutions can still produce patterned unequal punishment across time and cases.",
      ],
      commonClaims: [
        {
          claim:
      ...
      debateLines: [
        "A race-neutral label is not a full sentencing analysis.",
        "Punishment is built through statutes, charges, pleas, guidelines, and relief rules.",
        "The crack sentencing record is not a theory; it is one of the clearest documented examples.",
        "Reform matters because it shows the structure was changeable and policy-made.",
        "The serious question is how the system distributes punishment, not only how it describes itself.",
      ],
      shareCards: [
        {
          title: "Neutral on paper is not enough",
          text:
            "A sentencing rule can be written in race-neutral terms and still produce patterned unequal punishment through thresholds, mandatory minimums, charging, plea leverage, and access to relief.",
          context: "Use when legal wording is treated as proof of equal outcomes.",
        },
        {
          title: "Look before the judge",
          text:
            "Sentencing outcomes are shaped before final judgment through charges, plea terms, statutory thresholds, and guideline structure. That is where much of the disparity story sits.",
          context: "Use when the debate focuses only on the final sentence number.",
        },
        {
          title: "Reform proves it was policy-made",
          text:
            "The Fair Sentencing Act and First Step Act matter not only because they helped. They also show that the old punishment structure was not fixed or inevitable.",
  ...
  "mass-incarceration-policy-history": {
    ...
    argumentMode: {
      summary:
        "No. Crime levels matter, but the historical record does not support the claim that mass incarceration was just an automatic response to crime. The prison boom was shaped by sentencing law, drug policy, enforcement priorities, parole rules, plea-driven processing, and prison expansion.",
      keyPoints: [
        "The incarceration surge tracked major legal and institutional choices, including harsher drug laws, mandatory minimums, expanded prison capacity, and supervision rules.",
        "Those policies shaped both entry into the system and time spent inside it, which means prison growth cannot be reduced to crime rates alone.",
        "Black communities absorbed especially heavy cumulative exposure to arrest, imprisonment, supervision, family disruption, and downstream economic harm.",
        "Later reform efforts matter because they show policymakers could change sentencing structures and release rules, which undercuts the idea that the system was simply a fixed mirror of crime.",
        "This does not prove every rise in incarceration in every jurisdiction had the same cause or that federal policy alone explains all local patterns.",
        "The strongest claim is structural: law and enforcement architecture helped build a punishment system whose burdens fell unevenly and were not inevitable.",
      ],
      commonClaims: [
        {
          claim:
      ...
      debateLines: [
        "Crime matters, but punishment systems still have authors.",
        "If law shapes who enters, how long they stay, and who gets relief, policy is not secondary.",
        "Neutral text on paper does not erase unequal exposure in practice.",
        "Reform history matters because it shows the system was made and could be remade.",
        "The better question is which rules built the burden, not whether crime existed.",
      ],
      shareCards: [
        {
          title: "Policy built the funnel",
          text:
            "Mass incarceration was shaped by more than crime totals. Sentencing law, drug policy, charging leverage, parole rules, and prison expansion changed who entered the system and how long they stayed.",
          context: "Use when prison growth is treated like an automatic social fact.",
        },
        {
          title: "Impact is broader than prison walls",
          text:
            "The burden did not stop at the sentence. Surveillance, supervision, family disruption, income loss, and civic exclusion spread the impact across Black communities.",
          context: "Use when the debate narrows harm to the people formally incarcerated.",
        },
        {
          title: "Reform proves choice",
          text:
            "When lawmakers later changed sentencing structures and release rules, they showed the system was policy-made. What policy built, policy can change.",
