const EXPLAINER_EDITORIAL = {
  ...
  "white-house-dei-economic-study": {
    ...
    argumentMode: {
      summary:
        "The DEI study can raise a policy question, but its headline claim is stronger than the evidence because the proxy does not directly measure DEI policy, hiring quality, or causation.",
      keyPoints: [
