...
const CLAIM_PATTERNS = [
  ...
  {
    name: "Population share -> guaranteed seats",
    description:
      "Statewide demographics are treated as if Section 2 guarantees proportional representation without district-level proof about cracking, packing, and electoral opportunity.",
