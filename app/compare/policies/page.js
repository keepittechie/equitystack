...
export default async function ComparePoliciesPage({ searchParams }) {
  ...
  const rows = (data.items || []).map((item) => ({
    ...
    direction: item.impact_direction || "N/A",
    ...
    president: item.president || "N/A",
    year: item.year_enacted || "N/A",
  }));
  const highestScore =
    items
        ...
        <>
          ...
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <KpiCard
              ...
              value={highestScore?.black_impact_score_display || "N/A"}
              description={
                highestScore
            ...
            <KpiCard
              ...
              value={lowestScore?.black_impact_score_display || "N/A"}
              description={
                lowestScore
