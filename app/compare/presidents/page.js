          ...
          <Panel key={item.president_slug || item.president_name} padding="md" className="space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              ...
              <MetricCard
                density="compact"
                label="Top domain"
                value={item.top_domain?.domain || "N/A"}
              />
            </div>
        ...
        <>
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <KpiCard
              ...
              value={directLeader ? formatScore(directLeader.direct_normalized_score) : "N/A"}
              description={
                directLeader
            ...
            <KpiCard
              ...
              value={directGap != null ? formatScore(directGap) : "N/A"}
              description={
                directLeader && directRunnerUp
            ...
            <KpiCard
              ...
              value={outcomeLeader ? outcomeLeader.direct_outcome_count ?? outcomeLeader.outcome_count ?? 0 : "N/A"}
              description={
                outcomeLeader
            ...
            <KpiCard
              ...
              value={systemicLeader ? formatScore(systemicLeader.systemic_normalized_score) : "N/A"}
              description={
                systemicLeader
