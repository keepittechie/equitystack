  ...
  return (
    <main className="mx-auto max-w-[1700px] space-y-4 px-4 py-4">
      <section className="space-y-3">
        <p className="font-mono text-[11px] uppercase tracking-wide text-gray-600">Canonical legislative workflow</p>
        <h1 className="text-lg font-semibold">Legislative Workflow</h1>
