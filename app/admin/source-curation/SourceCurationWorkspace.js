                              ...
                              <div className="grid gap-3 px-3 py-3 xl:grid-cols-2">
                                <div className="space-y-3">
                                  <InfoBlock label="Titles / Types">
                                    <div className="space-y-2">
                                      <div>{cluster.distinct_titles.join(" • ") || "N/A"}</div>
                                      <div className="text-[10px] text-[var(--admin-text-muted)]">
                                        {cluster.distinct_source_types.join(" • ") || "N/A"}
                                      </div>
                                    </div>
                                  </InfoBlock>
                                  <InfoBlock label="Publisher / Date">
                                    <div className="space-y-2">
                                      <div>{cluster.distinct_publishers.join(" • ") || "N/A"}</div>
                                      <div className="text-[10px] text-[var(--admin-text-muted)]">
                                        {cluster.distinct_published_dates.join(" • ") || "N/A"}
                                      </div>
                                    </div>
                                  </InfoBlock>
