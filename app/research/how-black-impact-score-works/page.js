...
const CURRENT_ADMIN_SCORE_GATES = [
  {
    label: "Promise only",
    tone: "default",
    title: "Public accountability does not equal scoreability",
    description:
      "A sourced promise can stay public without entering the score pipeline. Promises describe intent, not completed impact.",
  },
  {
    label: "Governing action",
    tone: "info",
    title: "Real actions are the score gate",
    description:
      "Executive orders, agency actions, judicial effects, and other governing mechanisms are the bridge between intent and measurable outcomes.",
  },
  {
    label: "Scoring ready",
    tone: "warning",
    ...
    description:
      "Current-administration actions remain public but unscored until implementation and measurable population-impact evidence are both attached.",
  },
];
  ...
  return (
    <main className="space-y-4">
      ...
      <section className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
        <MethodologyCallout
          title="Current-administration score gate"
          description={CURRENT_ADMIN_METHOD_STATEMENT}
        />
        <DiscoveryGuidancePanel
          eyebrow="Current-admin score states"
          title="How the live rollout affects score interpretation"
          description="Current-administration records can be public before they are scoreable, and they can be eligible before a formal scoring pass is complete."
          items={CURRENT_ADMIN_SCORE_GATES}
        />
      </section>
      ...
      <section className="space-y-5">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <SurfaceCard>
            ...
            <p className="mt-3 text-sm leading-7 text-[var(--ink-soft)]">
              Public president ranking adds one more transparent layer on top of that. EquityStack shows a raw average score,
              a coverage-adjusted score, and an overall ranking score. The public leaderboard orders presidents by the overall
              ranking score so presidencies with only a few scored outcomes do not outrank fuller records solely because their
              averages are cleaner.
            </p>
          </SurfaceCard>
