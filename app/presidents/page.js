    ...
    <main className="space-y-4">
      ...
      <section className="hero-panel p-4">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--ink-soft)]">
          Leaderboard order uses an overall ranking score that starts with verified outcome averages,
          adjusts for evidence coverage, and further limits sparse low-confidence records. That means a
          slightly lower raw average can still rank higher when the record is backed by more scored outcomes.
        </p>
      </section>
      ...
      <ImpactOverviewCards
        items={[
          ...
          },
          {
            ...
            value: averageFinalScore == null ? "N/A" : formatScore(averageFinalScore),
      ...
      <section className="space-y-4">
        <Panel padding="md" className="space-y-4">
          <SectionIntro
            ...
            description="This ranking shows how presidents compare on the current public Black Impact Score. It stays anchored in documented outcomes, then adds reliability damping so thin low-confidence records do not outrank fuller presidencies too easily."
          />
          <PresidentRankingBoard
            items={topRanked}
          ...
          <MethodologyCallout description="Scores reflect measured policy impact in the EquityStack dataset, not a complete judgment of a presidency. LOW and VERY LOW confidence presidential records are rank-dampened beyond the base coverage adjustment so sparse records do not dominate the leaderboard." />
        </Panel>
      </section>
      ...
      <section className="space-y-4">
        ...
        <Panel padding="md" className="bg-[rgba(18,31,49,0.52)]">
          ...
          <p className="mt-3 max-w-4xl text-sm leading-7 text-[var(--ink-soft)]">
            Higher scores indicate stronger measured positive impact in the current dataset. Lower scores indicate stronger measured negative impact. The public leaderboard uses the overall ranking score, while the outcome-based score column lets you inspect the raw average before coverage adjustment and any extra low-coverage penalty.
          </p>
          {showBillComparison ? (
            <p className="mt-3 max-w-4xl text-sm leading-7 text-[var(--ink-soft)]">
        ...
        <ComparisonMetricsTable
          ...
          metrics={[
            { key: "final_score", label: "Overall ranking score" },
