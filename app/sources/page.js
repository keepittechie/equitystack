    ...
    <main className="space-y-4">
      ...
      <Panel padding="md">
        ...
        <p className="mt-4 text-sm leading-7 text-[var(--ink-soft)]">
          Use this page to verify claims, inspect what kinds of evidence support Black policy impact analysis, and see how widely a source is used across the public site.
        </p>
