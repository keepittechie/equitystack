...
initialize_equitystack_environment() {
  ...
  DEFAULT_OLLAMA_URL="${EQUITYSTACK_LLM_ENDPOINT:-${EQUITYSTACK_OLLAMA_URL:-}}"
  DEFAULT_OLLAMA_TIMEOUT="${EQUITYSTACK_LLM_TIMEOUT:-${EQUITYSTACK_OLLAMA_TIMEOUT:-240}}"
  ...
  DEFAULT_CURRENT_ADMIN_OPENAI_BASE_URL="${EQUITYSTACK_OPENAI_BASE_URL:-${OPENAI_BASE_URL:-https://api.openai.com/v1}}"
}
