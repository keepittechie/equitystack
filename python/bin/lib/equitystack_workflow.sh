...
initialize_equitystack_environment() {
  ...
  DEFAULT_PROVIDER_MODEL="${EQUITYSTACK_LLM_MODEL:-${EQUITYSTACK_OPENAI_MODEL:-${OPENAI_MODEL:-gpt-4.1-mini}}}"
  DEFAULT_MODEL_VERIFIER="${EQUITYSTACK_MODEL_VERIFIER:-${EQUITYSTACK_MODEL_CHEAP:-$DEFAULT_PROVIDER_MODEL}}"
  DEFAULT_MODEL_CHEAP="$DEFAULT_MODEL_VERIFIER"
  DEFAULT_MODEL_REVIEW="${EQUITYSTACK_MODEL_REVIEW:-$DEFAULT_PROVIDER_MODEL}"
  DEFAULT_MODEL_FALLBACK="${EQUITYSTACK_MODEL_FALLBACK:-$DEFAULT_MODEL_VERIFIER}"
  DEFAULT_MODEL_EXECUTOR="${MCP_MODEL:-${EQUITYSTACK_MODEL_EXECUTOR:-$DEFAULT_PROVIDER_MODEL}}"
  DEFAULT_OPENAI_BASE_URL="${EQUITYSTACK_OPENAI_BASE_URL:-${OPENAI_BASE_URL:-https://api.openai.com/v1}}"
  DEFAULT_LLM_ENDPOINT="${EQUITYSTACK_LLM_ENDPOINT:-${EQUITYSTACK_OLLAMA_URL:-$DEFAULT_OPENAI_BASE_URL}}"
  DEFAULT_LLM_TIMEOUT="${EQUITYSTACK_LLM_TIMEOUT:-${EQUITYSTACK_OLLAMA_TIMEOUT:-240}}"
  DEFAULT_REVIEW_TIMEOUT_SENIOR="${EQUITYSTACK_REVIEW_TIMEOUT_SENIOR:-${EQUITYSTACK_OLLAMA_TIMEOUT_SENIOR:-$DEFAULT_LLM_TIMEOUT}}"
  DEFAULT_REVIEW_TIMEOUT_VERIFIER="${EQUITYSTACK_REVIEW_TIMEOUT_VERIFIER:-${EQUITYSTACK_OLLAMA_TIMEOUT_VERIFIER:-240}}"
  DEFAULT_CURRENT_ADMIN_REVIEW_MODEL="${EQUITYSTACK_CURRENT_ADMIN_REVIEW_MODEL:-${EQUITYSTACK_OPENAI_MODEL:-gpt-4.1}}"
  DEFAULT_CURRENT_ADMIN_VERIFIER_MODEL="${EQUITYSTACK_CURRENT_ADMIN_VERIFIER_MODEL:-$DEFAULT_CURRENT_ADMIN_REVIEW_MODEL}"
  DEFAULT_CURRENT_ADMIN_FALLBACK_MODEL="${EQUITYSTACK_CURRENT_ADMIN_FALLBACK_MODEL:-$DEFAULT_CURRENT_ADMIN_REVIEW_MODEL}"
  DEFAULT_CURRENT_ADMIN_OPENAI_BASE_URL="${EQUITYSTACK_CURRENT_ADMIN_OPENAI_BASE_URL:-$DEFAULT_OPENAI_BASE_URL}"
}
